...
const HumanRightsPage = () => (
  <MainWrapperContainer>
    ...
    <div className=''>
      <Row
        opt={{ isBoxed: true, classes: "wrapper-overflow human-rights-page" }}
      >
        ...
        <p>
          ...
          meio de ensino voluntário, preços acessíveis de nossos produtos e com
          muito investimento em ciência para ensino de tecnologia.
        </p>
